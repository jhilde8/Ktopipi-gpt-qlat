#!/bin/bash
#SBATCH --job-name=psrc_ATW
#SBATCH --output=psrc_ATW-%j.out
#SBATCH --error=psrc_ATW-%j.err
...
srun -n 8 python3 -m mpi4py /sdcc/u/jhildebra/Ktopipi-gpt-qlat/scripts/gpt-qlat-ATW-corr.py --mpi 1.1.2.4 --mpi 2.2.2 --job_tag_list "48I" --no-inversion > log.${SLURM_JOB_ID}.txt 2>&1
