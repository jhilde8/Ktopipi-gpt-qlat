...
source /sdcc/u/jhildebra/setup_env.sh
...
#source /hpcgpfs01/ic2software/anaconda/2024.10/etc/profile.d/conda.sh

export OMP_NUM_THREADS=32
export q_verbose=2

#export PYTHONPATH="/sdcc/u/jhildebra/Qlattice:$PYTHONPATH"
...
srun -n 1 /hpcgpfs01/ic2software/anaconda/2024.10/bin/python3 -m mpi4py /sdcc/u/jhildebra/Ktopipi-gpt-qlat/scripts/gpt-qlat-meson-corr.py --mpi 1.1.1.1 --mpi 1.1.1 --job_tag_list "48I" --no-inversion > log.full.txt 2>&1
