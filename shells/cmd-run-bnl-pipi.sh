...
srun -n 8 python3 -m mpi4py /sdcc/u/jhildebra/Ktopipi-gpt-qlat/scripts/gpt-qlat-pipi-fc.py --mpi 1.1.2.4 --mpi 2.2.2 --job_tag_list "48I" --no-inversion > log.${SLURM_JOB_ID}.txt 2>&1
