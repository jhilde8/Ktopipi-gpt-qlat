...
time nix-shell /home/jhildebrand28/Qlattice/nixpkgs/shell.nix --run 'mpiexec -n 1 --oversubscribe --bind-to none python3 -m mpi4py /home/jhildebrand28/ktopipi/scripts/prop_gt.py --mpi 1.1.1.1 --mpi 1.1.1 --job_tag_list "16IH2" --no-inversion' >log-test.full.txt 2>&1
