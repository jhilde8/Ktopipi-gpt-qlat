...
def get_cexpr_pipi_corr_psnk_psrc():
    ...
    def calc_cexpr():
        ...
        #The number of times the momentum projection functions are called are set by us, we tell this loop how many modes we want to include. 
       #The '0' mode here calls the function that applies the (0,0,0) momentum projection. The '1' mode applies the (1,1,1) momentum projection
       for mode_src in [ 0, 1, ]: 
            for mode_snk in [ 0, 1, ]:
                exprs += [
                        #
